 ...
 */
@RestController
@RequestMapping({"/notify/mallTestPayNotify.do"})
public class MALLPayTestNotifyController {
    private static final Logger logger = LoggerFactory.getLogger(MALLPayTestNotifyController.class);

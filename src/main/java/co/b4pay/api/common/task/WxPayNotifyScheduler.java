...
@Component
public class WxPayNotifyScheduler {
    private static final Logger logger = LoggerFactory.getLogger(WxPayNotifyScheduler.class);
    ...
    public void runJob() {
        List<JobTrade> jobTradeList = jobTradeDao.findByChannelTypeAndStatusAndExecTimeLessThanEquals(ChannelType.WEIXIN, 0, DateUtil.getTime());

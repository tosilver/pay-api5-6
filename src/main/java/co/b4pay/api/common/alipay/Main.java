...
public class Main {
    ...
    public void test_trade_precreate() {
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                .setNotifyUrl("http://b4pay.ngrok.xiaomiqiu.cn/aliSPayNotify.do")//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("Z://qr-%s.png", response.getOutTradeNo());

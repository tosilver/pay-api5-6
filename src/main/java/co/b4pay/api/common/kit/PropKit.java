package co.b4pay.api.common.kit;
...
public class PropKit {
    ...
    public static Prop use(String fileName) {
        return use(fileName, Constants.CHARSET_UTF8);
    }
    ...
    public static Prop use(File file) {
        return use(file, Constants.CHARSET_UTF8);
    }
    ...
    public static Prop getProp() {
        if (prop == null) {
            // throw new IllegalStateException("Load propties file by invoking PropKit.use(String fileName) method
            // first.");
